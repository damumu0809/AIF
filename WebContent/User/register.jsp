...
<body id="signup-page">
    <div class="page-form">
    	<form id="signup-form" action="user_register" method="post" namespace="/" theme="simple">
            ...
            <div class="body-content">
                <div class="form-group">
                    <div class="input-icon right"><i class="fa fa-user"></i>
                        <input type="text" placeholder="用户名" id="nickname" name="nickname" class="form-control" >
                    </div>
                </div>
                <div class="form-group">
...
登陆</a>
                    <button  id="register" type="submit" class="btn btn-info pull-right">注册 &nbsp;
        ...
        //发送验证码
  	    $("#sendCode").click(function(){
        	...
        	if( email == "") {
        		...
        		var data = {email:  email, nickname: nickname, passwd: passwd};
        		$.post("/ssh/user_sendCode",data,function(res){
        			alert(res);
        		});
        	}
        });
